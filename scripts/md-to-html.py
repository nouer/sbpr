#!/usr/bin/env python3
"""Markdown to HTML converter for sbpr docs.

Usage:
    python3 md-to-html.py <input.md> <output.html> [--images-dir DIR]

Converts a Markdown file to a styled HTML page with sbpr blue theme.
...
<head>
    ...
    <title>{title} -- シンプル血圧記録</title>
    <meta name="description" content="{description}">
    <meta property="og:title" content="{title} -- シンプル血圧記録">
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Convert Markdown to styled HTML for sbpr docs.")
