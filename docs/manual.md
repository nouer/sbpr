...
5. 期間切り替え（7日/30日/90日/全期間）はモードに関係なく使えます

> **ボタンの色の区別:** モード選択ボタン（連続/日中・夜間/日中のみ/夜間のみ）と期間選択ボタン（7日/30日/90日/全期間）は異なる色で表示されるため、直感的に操作できます。
...
- 期間ボタン（7日/30日/90日/全期間）は血圧グラフと連動します
...
1. **診断範囲を選択**します（7日 / 30日 / 90日 / 全期間）。デフォルトは7日です
2. 「診断を開始」ボタンをタップ
